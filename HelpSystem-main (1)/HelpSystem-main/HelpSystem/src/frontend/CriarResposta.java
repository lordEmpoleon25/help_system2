...
public class CriarResposta {
	...
	public void window() {
		...
		JFrame jframe = new JFrame("Escreva sua resposta");
...
//		campoPergunta.setToolTip("Olá, qual a sua dúvida?");
		...
		enviar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				usuario.setPergunta(campoResposta.getText());
				usuario.getNome();
				cadastro.inserirpergunta(usuario);

				
				JOptionPane.showMessageDialog(enviar, "Resposta Enviada!");
